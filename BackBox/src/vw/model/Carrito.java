...
public class Carrito extends javax.swing.JFrame {
    ...
    public Carrito(ArrayList x, String nom,int tipoVenta,ArrayList acciones) throws ClassNotFoundException {
        initComponents();
        inicio();
        this.nom = nom;
    ...
    private void initComponents() {
        ...
        setTitle("Agregar Productos - BackBox");
    ...
    public void Añadir() throws ClassNotFoundException {
        ...
        if (i == -1) {
            ...
            String Pre = (String) jTable1.getValueAt(i, 4).toString();
            double preci = Double.parseDouble(Pre);
            double preIva=Double.parseDouble(Iva);
            Producto pro = null;
            boolean esta = false;
            for (int k = 0; k < pr.size(); k++) {
                pro = (Producto) pr.get(k);
            ...
            if (esta == false) {
                Producto p = new Producto(cod, Nom, preci, 1,preIva);
                pr.add(p);
            }
            Venta v = new Venta(pr, nom,tipoVenta,ListAcciones);
    ...
    Venta m;
        try {
            m = new Venta(pr, nom,tipoVenta,ListAcciones);
            this.dispose();
            m.setVisible(true);
    ...
    public void Buscar() throws ClassNotFoundException {
        ...
        if (jComboBox1.getSelectedIndex() == 0) {
            query = "select  distinct  cod_producto \"Codigo\",nombre,costo,iva,precio_desc \"Precio Venta\",descu \"Descuento\",cantidad,categoria.descripcion "
...
//            Control.rs.close();
    ...
    public void inicio() throws ClassNotFoundException {
        Control.conectar();
        Producto temp = null;
        String query = "select cod_producto \"Codigo\",nombre,costo,iva,precio_desc \"Precio Venta\",descu \"Descuento\",cantidad,categoria.descripcion "
