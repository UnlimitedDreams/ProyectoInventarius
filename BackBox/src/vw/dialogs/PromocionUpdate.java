 ...
 * @author usuario
 */
public class PromocionUpdate extends javax.swing.JDialog {
    ...
    public PromocionUpdate(java.awt.Frame parent, boolean modal, int codPromo) {
        super(parent, modal);
        initComponents();
    ...
    public void recuperarDatos() {
        try {
            Control.conectar();
            Control.ejecuteQuery("select * from promociones where cod_promocion=" + codPromocion);
            while (Control.rs.next()) {
                System.out.println("entro aqui");
                jDateChooser1.setDate(Control.rs.getDate(2));
                jDateChooser2.setDate(Control.rs.getDate(3));
                Porcentaje.addItem(Control.rs.getInt(4));
                Tipo.addItem(Control.rs.getString(5));
            ...
            Control.ejecuteQuery("select a.serie_producto,nombre,precio_venta,a.descu,a.precio_desc,a.cod_producto,c.valordescuento "
                    + "from producto a,promociones b,detallepromociones c\n"
                    + "where\n"
                    + "a.cod_producto=c.codproducto and \n"
                    + "b.cod_promocion=c.codpromo and b.cod_promocion=" + codPromocion);
            while (Control.rs.next()) {
                ...
                temp.setCosto(Control.rs.getDouble(7));
                productos.add(temp);
            }
    ...
    public void UpdatePromocion() throws SQLException, ClassNotFoundException {
        if (ValidarTable()) {
            ...
            try {
                ...
                while (Control.rs.next()) {
                    listCodigos.add(Control.rs.getInt(1));
                }
                ...
                r = Control.ejecuteUpdate("insert into promociones values(" + this.codPromocion + ",'" + fechaString + "','" + fecha2String
            ...
            if (r) {
                Entrada.muestreMensajeV("Se Actualizo Exitosamente la promocion");
                promo.inicio();
                this.dispose();
            } else {
            ...
            if (Esta == false) {
                ...
                try {
                    ...
                    String query = "select distinct * from (\n"
                            + "select nombre,precio_desc,0,cod_producto from producto\n"
                            + "where\n"
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 650, 30));
        ...
        jPanel1.add(c, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 650, 130));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 650, 160));

        jLabel4.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        jLabel4.setText("Estado");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 30, 50, -1));
        ...
        jPanel1.add(Cate, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, 130, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
        jLabel5.setText("Categoria");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 70, 80, -1));

        Estado.setFont(new java.awt.Font("Segoe UI Light", 0, 18)); // NOI18N
        Estado.setMaximumRowCount(10);
        Estado.setAutoscrolls(true);
        Estado.setMinimumSize(new java.awt.Dimension(31, 22));
        Estado.setPreferredSize(new java.awt.Dimension(31, 25));
        Estado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EstadoActionPerformed(evt);
            }
        });
        jPanel1.add(Estado, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 30, 60, -1));
    ...
    private void TipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TipoActionPerformed
        ...
        if (Tipo.getSelectedItem().toString().trim().equalsIgnoreCase("Producto")) {
            Cate.setEnabled(false);
    ...
    private void CateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CateActionPerformed
        System.err.println("entro aqui " + this.condicion);
        if (this.condicion == 2) {
            if (Cate.getSelectedItem().toString().equalsIgnoreCase("Seleccione")) {
                ...
                try {
                    ...
                    productos.clear();
                    iniciar();
                    System.out.println("tamaño size " + productos.size());
                    String categoria[] = Cate.getSelectedItem().toString().split("-");
                    Control.conectar();
                    Producto temp = null;
                    System.out.println("select nombre,precio_venta,0,cod_producto,serie_producto from producto , categoria "
