 ...
 * @author usuario
 */
public class RolUpdate extends javax.swing.JFrame {
     ...
     * @param cod
     */
    public RolUpdate(int rol,String NombreRol) {
        initComponents();
    ...
    public void CargarDatos() {
        try {
            Control.conectar();
            Control.ejecuteQuery("select codacciones,nom_accion from detalleactividad a , acciones b where a.cod_accion=b.codacciones\n"
                    + "and a.cod_rol=" + rol);
...
//                        
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new Acciones(this, true,2).setVisible(true);
