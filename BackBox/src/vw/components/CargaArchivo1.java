 ...
 * @author Britany
 */
public class CargaArchivo1 extends javax.swing.JFrame {
    ...
    public CargaArchivo1(ArrayList p, String nom, ArrayList acciones) throws ClassNotFoundException {
        try {
            initComponents();
            this.usuario = nom;
            this.nombre = "";
            ...
            Logger.getLogger(CargaArchivo1.class.getName()).log(Level.SEVERE, null, ex);
        }
