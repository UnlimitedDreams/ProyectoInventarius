 ...
 * @author usuario
 */
public class MaestroMenuItem extends javax.swing.JFrame {
     ...
     */
    //, ArrayList Acciones
    public MaestroMenuItem(String Usuario) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(MaestroMenuItem.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
