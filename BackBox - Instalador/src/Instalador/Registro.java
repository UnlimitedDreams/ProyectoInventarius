...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel4.setText("Datos de la Empresa");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 60, -1, -1));
        ...
        jPanel3.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, -1, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel3.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 380, 28));
        ...
        jPanel3.add(correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 360, 380, 28));
        ...
        jPanel3.add(Nit, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 380, 28));
        ...
        jPanel3.add(nom, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 200, 380, 28));
        ...
        jPanel3.add(tel, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, 380, 28));
        ...
        jPanel3.add(cel, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 280, 380, 28));
        ...
        jPanel3.add(dir, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 320, 380, 28));
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(423, 450, 120, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            int codEmp = Sequence.seque("select max(codempresa) from empresahistorico");
            Control.conectar();
            Date fecha=new Date();
            String regimen[]=jComboBox1.getSelectedItem().toString().split("-");
            Control.ejecuteUpdate("insert into empresahistorico values("+codEmp+","+Integer.parseInt(regimen[0])+
                    ",'"+fecha+"','"+Nit.getText()+"','"+nom.getText()+"','"+tel.getText()+"','"+
                    cel.getText()+"','"+dir.getText()+"','"+correo.getText()+"')");
        } catch (Exception ex) {
